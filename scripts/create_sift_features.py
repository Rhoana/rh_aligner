...
def create_sift_features(tiles_fname, out_fname, jar_file, conf_fname=None, threads_num=1):
    ...
    java_cmd = 'java -Xmx8g -XX:ParallelGCThreads=1 -Djava.awt.headless=true -cp "{0}" org.janelia.alignment.ComputeSiftFeatures --all --url {1} --targetPath {2} --threads {3} {4}'.format(\
